...
CMAKE_FLAGS="-DCUDA_TOOLKIT_ROOT_DIR=$CUDA_TOOLKIT_ROOT_DIR -DTORCH_CUDA_ARCH_LIST=$TORCH_CUDA_ARCH_LIST -DCMAKE_C_COMPILER=/usr/local/bin/gcc7 -DCMAKE_CXX_COMPILER=/usr/local/bin/g++7"
